## Elasticsearch
- [Java에서 사용하는 ES 클라이언트 비교](elasticsearch/compare-es-clients-in-java.md)
...
## Java
- [Jackson boolean 타입](java/boolean-type-in-jackson.md)
- [DTO](java/dto.md)

## Spring
- [Spring bean lifecycle](spring/spring-bean-lifecycle.md)
- [ResourceLoader](spring/resourceloader.md)
- [Webflux MvcTest 예제](spring/webflux-mvctest-example.md)

## Gradle
- [Gradle에서 자주 사용되는 플러그인들](gradle/plugins.md)